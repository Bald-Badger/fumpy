...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone IV E" EXCEPTION_HANDLING="NO" PIPELINE=10 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 aclr clk_en clock dataa datab result
...
module  FP32_mult_altfp_mult_nvo
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //FP32_mult_altfp_mult_nvo
//VALID FILE
...
module FP32_mult (
	...
	FP32_mult_altfp_mult_nvo	FP32_mult_altfp_mult_nvo_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
