...
# Shuai: put file in simulation directory (outside work)
# and run the command following:
# "do vhdl-libiary-setup.tcl"
# Shuai: change path name!!!
set path_to_quartus C:/intelFPGA/18.1/quartus
# Shuai: modify the line below base on need.
set type_of_sim ip_functional
