...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone IV E" DIRECTION="ADD" OPTIMIZE="SPEED" PIPELINE=14 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 aclr clock dataa datab result
...
module  FP_add_sub_altbarrel_shift_35e
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //FP_add_sub_altbarrel_shift_35e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_add_sub_altbarrel_shift_98g
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	assign
		...
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //FP_add_sub_altbarrel_shift_98g
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_add_sub_altpriority_encoder_ii9
	( 
	data,
	q,
	zero) ;
...
endmodule //FP_add_sub_altpriority_encoder_ii9
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_add_sub_altpriority_encoder_i39
	( 
	data,
	q) ;
	input   [15:0]  data;
...
endmodule //FP_add_sub_altpriority_encoder_i39

//synthesis_resources = reg 5 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_add_sub_altpriority_encoder_cna
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	FP_add_sub_altpriority_encoder_ii9   altpriority_encoder21
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder21_q),
	.zero(wire_altpriority_encoder21_zero));
	FP_add_sub_altpriority_encoder_i39   altpriority_encoder22
	( 
	.data(data[31:16]),
...
endmodule //FP_add_sub_altpriority_encoder_cna

//synthesis_resources = lpm_add_sub 14 lpm_compare 1 reg 716 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_add_sub_altfp_add_sub_lkj
	( 
	aclr,
	clock,
	dataa,
...
`endif
	...
	FP_add_sub_altbarrel_shift_35e   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	FP_add_sub_altbarrel_shift_98g   rbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	FP_add_sub_altpriority_encoder_cna   trailing_zeros_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //FP_add_sub_altfp_add_sub_lkj
//VALID FILE
...
module FP_add_sub (
	...
	FP_add_sub_altfp_add_sub_lkj	FP_add_sub_altfp_add_sub_lkj_component (
				.aclr (aclr),
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
